...
class qa_cp_page {
	...
	function process_request($request) {
		...
		$selectspec=array(
			'columns' => array(
				'^posts.postid', '^posts.categoryid', '^posts.name', '^posts.type', 'basetype' => 'LEFT(^posts.type,1)', 'hidden' => "INSTR(^posts.type, '_HIDDEN')>0",
			...
			'arguments' => array('is_community','Q'),
		);			
